...
//talon
    ...
    setServo(3,90);
//muslo
    setServo(4,90); //pierna sagital 1  | 180 +
    setServo(5,90);
...
void avanzar(){
//step 1
    setServo(0,100); //rodilla 1 | 0 + flexionado
...
//step 2
    ...
    setServo(1,100); //pierna sagital 1  | 180 +
...
//step 3
    ...
    setServo(1,80); //pierna sagital 1  | 180 +

    //setServo(6,60); //rodilla 2 | 180 + flexionado
    //setServo(7,70); //pierna sagital 2  | 0 +    
delay(vel); 
//step 4
    setServo(0,90); //rodilla 1 | 0 + flexionado
